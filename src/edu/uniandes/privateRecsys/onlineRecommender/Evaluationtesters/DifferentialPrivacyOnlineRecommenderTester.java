...
public class DifferentialPrivacyOnlineRecommenderTester extends AbstractRecommenderTester {
	...
	public void setModelAndUpdaters(
		...
		if(!(agregator instanceof DifferentialPrivacyAggregator))
			throw new TasteException("DifferentialPrivacyOnlineRecommenderTester has to have a DifferentialPrivacyAggregator as user-item agregator");
